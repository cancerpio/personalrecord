# Capability: Deploy Quality Gate

## Purpose
This capability ensures that automated tests act as a mandatory quality gate before any build and deployment, so that a failing test suite blocks the deployment instead of shipping broken code.
